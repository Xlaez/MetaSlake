"""
Django settings for metastake project.
...
WSGI_APPLICATION = 'metastake.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "MetaSlake ADMIN",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "MetaSlake",

    "site_brand": "Metaslake Admin",
    ...
    "welcome_sign": "Welcome to the MetaSlake Admin Section",

    # Copyright on the footer
    "copyright": "MetaSlake Ltd",

    # The model admin to search from the search bar, search bar omitted if excluded
    "search_model": "stake.Chain", "stake.Stake"
    ...
    "usermenu_links": [
        {"name": "MetaSlake Platform", "url": "/", "new_window": True},
        {"model": "auth.user"}
    ],
    ...
    "icons": {
        ...
        "stake.chain": "fas fa-link",
        "stake.stake": "fas fa-coins",
    },
